...
void MultiGPUUIApp::PopulateShadowMapCommands(std::shared_ptr<GCommandList> cmdList)
{
...
void MultiGPUUIApp::PopulateNormalMapCommands(std::shared_ptr<GCommandList> cmdList)
{
	//Draw Normals
	{
...
void MultiGPUUIApp::PopulateAmbientMapCommands(std::shared_ptr<GCommandList> cmdList)
{
	//Draw Ambient
	{
		cmdList->SetDescriptorsHeap(&srvTexturesMemory);
...
void MultiGPUUIApp::PopulateForwardPathCommands(std::shared_ptr<GCommandList> cmdList)
{
...
void MultiGPUUIApp::PopulateDrawCommands(std::shared_ptr<GCommandList> cmdList,
...
void MultiGPUUIApp::InitDevices()
{	
...
void MultiGPUUIApp::InitFrameResource()
{
...
void MultiGPUUIApp::InitRootSignature()
{
...
void MultiGPUUIApp::InitPipeLineResource()
{
	defaultInputLayout =
	{
		{
...
void MultiGPUUIApp::CreateMaterials()
{
...
void MultiGPUUIApp::InitSRVMemoryAndMaterials()
{
	srvTexturesMemory = 
...
void MultiGPUUIApp::MipMasGenerate()
{
	try
	{
...
void MultiGPUUIApp::CalculateFrameStats()
{
...
void MultiGPUUIApp::UpdateShadowTransform(const GameTimer& gt)
{
...
void MultiGPUUIApp::UpdateShadowPassCB(const GameTimer& gt)
{
...
void MultiGPUUIApp::UpdateMainPassCB(const GameTimer& gt)
{
...
void MultiGPUUIApp::UpdateSsaoCB(const GameTimer& gt)
{
