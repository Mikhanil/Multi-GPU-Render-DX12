...
public:
     ...
     */
    virtual D3D12_CPU_DESCRIPTOR_HANDLE GetShaderResourceView(ID3D12Device* device, const D3D12_SHADER_RESOURCE_VIEW_DESC* srvDesc = nullptr) const = 0;
     ...
     */
    virtual D3D12_CPU_DESCRIPTOR_HANDLE GetUnorderedAccessView(ID3D12Device* device, const D3D12_UNORDERED_ACCESS_VIEW_DESC* uavDesc = nullptr) const = 0;
