...
GMemory::GMemory(D3D12_CPU_DESCRIPTOR_HANDLE descriptor, D3D12_GPU_DESCRIPTOR_HANDLE gpuDescriptor , uint32_t handlerCount, uint32_t descriptorSize, std::shared_ptr<GHeap> heap)
