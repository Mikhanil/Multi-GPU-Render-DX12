...
void GResourceStateTracker::AddCurrentState(ComPtr<ID3D12Resource> resource, D3D12_RESOURCE_STATES currentState, UINT subresource)
{
...
void GResourceStateTracker::TransitionResource(ID3D12Resource* resource, D3D12_RESOURCE_STATES stateAfter, UINT subResource)
{
    if (resource)
    {
...
void GResourceStateTracker::TransitionResource(const GResource& resource, D3D12_RESOURCE_STATES stateAfter, UINT subResource)
{
