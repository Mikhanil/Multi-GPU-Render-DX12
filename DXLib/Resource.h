...
public:
	 ...
	 */
	virtual D3D12_CPU_DESCRIPTOR_HANDLE GetShaderResourceView(ID3D12Device* device,
	 ...
	 */
	virtual D3D12_CPU_DESCRIPTOR_HANDLE GetUnorderedAccessView(ID3D12Device* device,
