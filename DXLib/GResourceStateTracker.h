...
public:
    ...
    static void AddCurrentState(ComPtr<ID3D12Resource> resource, D3D12_RESOURCE_STATES currentState, UINT subresource = D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES);
