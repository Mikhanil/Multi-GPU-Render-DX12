...
{
public:
	PartSplitGPU(HINSTANCE hInstance);
	~PartSplitGPU() override
	{
		PartSplitGPU::Flush();
...
private:
	...
	void inline AddMultiDeviceOpaqueRenderComponent(GameObject* object, std::wstring modelName, RenderMode::Mode psoType = RenderMode::Opaque);
