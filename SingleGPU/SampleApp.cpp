...
namespace Common
{
	...
	bool SampleApp::Initialize()
	{
		...
		ssao->SetPSOs(*psos[RenderMode::Ssao], *psos[RenderMode::SsaoBlur]);
	...
	void SampleApp::BuildGameObjects()
	{
		...
		typedGameObjects[RenderMode::Debug].push_back(quadRitem.get());
		typedGameObjects[RenderMode::Quad].push_back(quadRitem.get());
		...
		typedGameObjects[RenderMode::SkyBox].push_back(skySphere.get());
		...
		for (int i = 0; i < 11; ++i)
		{
			...
			typedGameObjects[RenderMode::Opaque].push_back(nano.get());
			...
			typedGameObjects[RenderMode::Opaque].push_back(doom.get());
		...
		for(int i = 0; i< 12; ++i)
		{
			for (int j = 0; j < 3; ++j)
			{
				...
				typedGameObjects[RenderMode::Opaque].push_back(atlas.get());
				...
				typedGameObjects[RenderMode::Opaque].push_back(pbody.get());
		...
		typedGameObjects[RenderMode::Opaque].push_back(platform.get());
		...
		typedGameObjects[RenderMode::Opaque].push_back(stair.get());
		...
		typedGameObjects[RenderMode::Opaque].push_back(columns.get());
		...
		typedGameObjects[RenderMode::Opaque].push_back(fountain.get());		
		...
		typedGameObjects[RenderMode::Opaque].push_back(mountDragon.get());
		...
		typedGameObjects[RenderMode::Opaque].push_back(desertDragon.get());
		...
		typedGameObjects[RenderMode::OpaqueAlphaDrop].push_back(griffon.get());
		...
		typedGameObjects[RenderMode::OpaqueAlphaDrop].push_back(griffon1.get());
	...
	void SampleApp::DrawSceneToShadowMap(std::shared_ptr<GCommandList> cmdList)
	{
		...
		DrawGameObjects(cmdList, typedGameObjects[RenderMode::OpaqueAlphaDrop]);
